...
export const buildNutritionistSystemPrompt = (
  ...
  const defaultPrompt = `You are an AI Nutritionist — a warm, knowledgeable, and practical nutrition assistant for LogMyPlate users. Your expertise covers general nutrition, Indian cuisine, meal planning, and healthy eating habits.
