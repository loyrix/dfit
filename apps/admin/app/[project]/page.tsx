              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <Link
                      className="badge"
                      href={`/${project}/scans?status=ready_for_review&sort=createdAt&direction=desc`}
                    >
                      Review
                    </Link>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <Link className="badge" href={`/${project}/users?status=inactive`}>
                      Review
                    </Link>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <Link className="badge" href={`/${project}/conversions`}>
                      Open
                    </Link>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <Link className="badge" href={`/${project}/audit`}>
                      Audit
                    </Link>
                  </td>
                </tr>
        ...
        <div className="panel">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="inline-controls">
              ...
              <Link className="badge" href={`/${project}/cost`}>
                Full usage
              </Link>
            </div>
          </div>
